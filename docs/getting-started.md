...
1. Download the latest `.dmg` file from [Releases](https://github.com/heesubsong/vibesmith-community/releases)
2. Open the `.dmg` file
...
[Sign up for Windows beta](https://github.com/heesubsong/vibesmith-community/issues/new?template=4-beta_request.yml)

### Linux

⏳ **Coming Soon!**

[Sign up for Linux beta](https://github.com/heesubsong/vibesmith-community/issues/new?template=4-beta_request.yml)
...
**Need help?** Ask in our [Discord](https://discord.gg/vibesmith) or [GitHub Discussions](https://github.com/heesubsong/vibesmith-community/discussions)!
