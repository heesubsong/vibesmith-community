...
4. **Report bug:**
   - [Create issue](https://github.com/heesubsong/vibesmith-community/issues/new?template=1-bug_report.yml)
   - Attach log files
...
# https://github.com/heesubsong/vibesmith-community/releases
```
...
2. ✅ Search [GitHub Issues](https://github.com/heesubsong/vibesmith-community/issues)
3. ✅ Check [FAQ](faq.md)
...
- 🐛 **Bug Report**: [Create Issue](https://github.com/heesubsong/vibesmith-community/issues/new?template=1-bug_report.yml)
